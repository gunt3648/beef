<?php include('server.php'); ?>
  ...
  <html lang="en">
    ...
    <body>
      <div class="container">
        <div class="row">
          <form method="post" action="register_guide.php" class="col-12">
            <?php include('errors.php'); ?>
              <h2>Register</h2>
              <div class="input-group">
                <label class="col-sm-3">Username</label>
                <input type="text" name="username" value="<?php echo $username;
                  ?>" minlength="5" class="col-sm-8 d-inline">
              </div>
              <div class="input-group">
              ...
              <div class="input-group">
                ...
                <input type="text" name="area" value="<?php echo $area; ?>" class="col-sm-8">
              </div>
              <div class="input-group">
